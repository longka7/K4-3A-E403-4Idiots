# Khảo sát bằng chứng — Track D2 (Productive Failure)
...
**3 quy tắc:**
1. Hỏi về hành vi/sự kiện đã xảy ra thật — không pitch ý tưởng, không hỏi "bạn có muốn...".
2. Hỏi chuyện cụ thể trong quá khứ — không hỏi dự đoán/ý kiến về tương lai.
3. Mình nói ít, để người trả lời nói nhiều — không dẫn dắt câu trả lời.

**3 phản xạ khi nghe:**
- Được khen ý tưởng → cảm ơn, quay lại hỏi hành vi thật.
- Nghe câu chung chung ("mình thường...") → hỏi lại "**lần gần nhất** là khi nào?".
- Nghe đề xuất tính năng → hỏi "cái đó giúp bạn làm được **gì cụ thể**?".

**Tuyệt đối tránh:** "Bạn có muốn AI cho làm bài trước khi học lý thuyết không?" — ai cũng gật, dữ liệu vô dụng.
...
- Tổng số người khảo sát: **___ / 20**
- Số người xác nhận pain: **___** → tỉ lệ **___%** (cần ≥50%)
- 3 câu trích dẫn nguyên văn mạnh nhất (đưa vào `spec.md` §1):
  1.
  2.
  3.
- Alternatives hiện tại người học đang dùng (từ câu hỏi chốt): ______

---

*Lưu ý: đây là khảo sát bằng chứng ban đầu (R1), khác với R6 — validation dùng prototype thật với ≥5 người, làm sau ở CP5. Xem `01-challenge-brief.md`/`04-rubric.md` trong repo đề bài.*
