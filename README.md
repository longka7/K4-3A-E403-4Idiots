...
| Nguyễn Tuấn Khanh | 2A202602819 | UX/Validation Lead | **CP3:** Viết kịch bản và quay video thao tác 30 giây theo đúng luồng AI thật. **CP4:** Viết `spec.md` §4b — chọn 4 nguyên tắc HAX/PAIR (G2, G4, G8, G9) và chỉ rõ vị trí áp dụng cụ thể trong `mock-cp2.html`. **CP5:** Tìm ≥2 willing user, ghi log + quote nguyên văn vào `validation/`, tạo file slides pdf, quay video demo dự phòng. |
